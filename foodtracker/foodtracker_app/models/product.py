from sqlalchemy import Column, Integer, String, ForeignKey, Date, func, DateTime, CheckConstraint, Numeric
...
class Product(Base):
    ...
    wasted_amount = Column(Numeric(10, 2), nullable=False, server_default='0.00', default=Decimal('0.00'))
    ...
    __table_args__ = (
       ...
       CheckConstraint('current_amount + wasted_amount <= initial_amount', name='check_amounts_lte_initial'),
    )